        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
				<div class="d-flex justify-content-center">
                    <button  data-toggle="modal" data-target="#modalPush" onclick="add()" class="btn bg-teal-400 btn-labeled btn-labeled-left"><b><i class="icon-plus3"></i></b> Add Category</button>
						...
						<table class="table " id="data">
                            ...
                            while($data = mysqli_fetch_assoc($category)){
								...
								<tr>
                                    ...
                                    <td><?=$data['name']?></td>
                                    <td><?=$data['owner']?></td>
                                    <td><button class="btn btn-warning btn-sm" data-target="#modalPush" data-toggle="modal" onclick="edit(<?=$id?>,'<?=$name?>','<?=$owner?>')">Edit</button> <button class="btn btn-danger btn-sm"  onclick="hapus(<?=$id?>)" >Hapus</button></td>
								</tr>
                                <?php } ?>
                            </tbody>
                        </table>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
											<div class="col-sm-12">
												...
												<input type="text" placeholder="Category name" name="name" id="name" class="form-control" >
