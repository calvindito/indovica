...
$row2 = mysqli_query($conn,"SELECT * FROM config where type = 'term'");
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Term & Condition</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Form Term & Condition</span>
                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
						    <div class="col-sm-6">
                                ...
                                <input type="text" hidden value="term" id="type" name="type">
                            </div>
                            <div class="col-sm-6">
