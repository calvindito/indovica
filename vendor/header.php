			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="<?=$vendor_url?>/index.php" class="nav-link">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
							    	<li class="nav-item"><a href="<?=$vendor_url?>/product/term.php" class="nav-link">Term & Condition</a></li>
								<li class="nav-item"><a href="<?=$vendor_url?>/product/index.php" class="nav-link">Product</a></li>
